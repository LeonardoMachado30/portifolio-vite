...
function useAsyncProjetos() {
  ...
  return { projetos, carregando, erro, reload: loadProjetos };
}
...
export function Exemplo() {
  ...
  // Projetos async
  const { projetos, carregando, erro, reload } = useAsyncProjetos();
  ...
  // LocomotiveScroll: dynamic update on projetos change
  useEffect(() => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="w-full flex justify-center p-8 pb-8 pt-0">
            <div
          ...
          <div className="w-full">
            ...
            <p className="text-base sm:text-lg text-gray-200 max-w-full sm:max-w-lg mx-auto md:mx-0">
        ...
        <section id="projetos" data-scroll-section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 sm:gap-8 lg:gap-10 p-0 sm:p-1">
            {carregando ? (
              ...
              <div className="col-span-full flex flex-col justify-center items-center">
                <Card>
                  <p>Erro: {erro}</p>
                  <button
                    className="mt-2 px-4 py-1 rounded bg-cyan-700 text-white hover:bg-cyan-800 transition"
                    onClick={reload}
                  >
                    Tentar novamente
                  </button>
                ...
                {projetos.map(proj => (
                  ...
                  >
                    <div className="flex flex-col p-3 sm:p-6">
                      <h3
                        className="text-lg sm:text-2xl font-semibold text-[#0ff]"
                        style={{
                          userSelect: 'none',
                        }}
                      >
